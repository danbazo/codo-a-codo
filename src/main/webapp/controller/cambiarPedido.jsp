...
<div class="container">
	...
	Pedido pedido = new Pedido(idPedido,nombre,apellido,usuario,email,direccion,localidad,provincia,codPostal,formaPago,titular,nroTarjeta,fechaVto,codigoSeg);
	
	PedidoDAO pedidoDAO = new PedidoDAO();
	Boolean guardoOK = pedidoDAO.modificarPedido(pedido);
	
	if(guardoOK) {
		out.println("<h4 class='text-success'>El pedido se modificó exitosamente</h4>");
	}else {
		out.println("<h4 class='text-danger'>Error en modificar pedido, intente nuevamente</h4>");
	}
